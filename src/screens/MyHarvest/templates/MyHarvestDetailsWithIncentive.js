...
/**
* @class MyHarvestDetailsWithIncentives
* @extends Component
* @summary Represents MyHarvestDetailsWithIncentives class.
* @description This is a MyHarvestDetailsWithIncentives class. It extands react Component class for using the functions comes along with it.
*/
export class MyHarvestDetailsWithIncentives extends Component {
                    ...
                    <TouchableOpacity
                        ...
                        <View style={HarvestDetailsStyles.subViewForMainList}>
                            <View style={HarvestDetailsStyles.loyaltyMemberGroupView}>
                                <View style={{ flex: 1 }}>
                                    <Image source={require('../../../assets/greendollar.png')} style={{ width: 24, height: 21, marginTop: 14, marginLeft: 10 }} />
                                </View>
                                <View style={{ flex: 7, flexDirection: "row" }}>
                                    <Text style={HarvestDetailsStyles.loyaltyMemberGroup}>Total Incentive: </Text>
                                    <Text style={HarvestDetailsStyles.loyaltyMemberText}>$1424.39</Text>
                                </View>
...
*/
export default connect(mapStateToProps, mapDispatchToProps)(MyHarvestDetailsWithIncentives);